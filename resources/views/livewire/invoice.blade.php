    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-orange-100/40 p-8 rounded-3xl">
            <header class="flex justify-between items-center mb-8">
                ...
                <div>
                    <p class="text-orange-600 font-semibold">Hastakala</p>
                ...
                <tbody>
                    @foreach ($order->orderItems as $item)
                        <tr class="text-lg">
                            ...
                            <td class="px-4 py-2">Npr{{ $item->product->price }}</td>
                            <td class="px-4 py-2">Npr{{ $item->product->price * $item->quantity }}</td>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot class="text-lg">
                    <tr class="font-semibold">
                        ...
                        <td class="px-4 py-2">Npr{{ $order->total }}</td>
                    </tr>
